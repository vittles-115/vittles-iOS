...
class DishObject: NSObject {
    ...
    convenience init(uniqueID:String,name:String, foodDescription:String, averageRating:Double,numberOfRatings:Int,type:String,restaurantName:String,restaurantRefID:String, imageURL:String) {
